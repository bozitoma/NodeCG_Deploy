...
const fs = __importStar(__webpack_require__(/*! fs */ "fs"));
// Packages
const json_1 = __webpack_require__(/*! klona/json */ "klona/json");
...
function default_1(cfgDirOrFile) {
    ...
    let isFile = false;
    try {
        isFile = fs_1.default.lstatSync(cfgDirOrFile).isFile();
        // eslint-disable-next-line @typescript-eslint/no-implicit-any-catch
    }
    catch (error) {
    ...
    const cfgDir = isFile ? path_1.default.dirname(cfgDirOrFile) : cfgDirOrFile;
    const cc = (0, cosmiconfig_1.cosmiconfigSync)('nodecg', {
        searchPlaces: isFile
...
"use strict";
module.exports = require("klona/json");
